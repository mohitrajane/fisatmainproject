...
The current education system uses mainly audio and some visual methods to teach students. Given in the increasing rate of learning disibility diganosed in students in India.[1] And research pointing to visual working memory is better in students with learning disibility[2]. It is clear we need a better form of teaching students with such disibility. With the current technology it is possible to add the usage of somesthetic senses to learning.\\

In this projetc we propose a system which uses a hologramic display with haptic feedback, which can we intraced with geusters using fingers. Hologram was selected as research has shown learning gemotry with hologram is better than tradional methods[3]. This project will focus on developing a system as described above to develope a new approch to learning basic gemotry.
