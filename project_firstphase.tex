...
We are extremely thankful to the Chairman, Mr.Paul Mundadan, who provided us with all the vital facilities required for the successful completion of our project.
We also thank out Principal, Dr. George Issac for the amenities he provided.We would like to express our sincere gratitude to Prof Dr.Prasad JC(H.O.D) who always guided us and rendered his maximum support in all phases of our project.
We are expressing our sincere gratitude to Ms.Reshmi R,Mr.Jestin Joy and Ms.Soumya S Raj,assistant professors of Department of Computer Science and Engineering for their constant support in every phase and for the source of strength in completing this work.As the project coordinators they have provided necessary assistance throughout the project. 
We would like to express our gratitude to the project in charge 
Mr.Mahesh C  for his constant support and encouragement and for rendering help in all phases of our project with patience and enthusiasm.
\newline
...
\section{\normalsize Bringing Video Game Characters into the Real Worldon a Holographic Light Field Display}
...
\section{\normalsize Ultraino: An Open Phased-Array System forNarrowband Airborne Ultrasound Transmission}
...
A realism sense is provided.
Passive haptic uses already existing objects for providing haptic sensations.
Pseudo-haptic feedback is a new technique which is used here.
...
Both motion parallax and stereoscopy is supported by augmented reality.
...
The HoloPlayer Unity SDK is used for tracking the finger.
Finger position is important to drives the  agent's animation.
Inverse kinematics is a process to recognize the finger position.
